...
type TranslationKeys = {
  ...
  aboutDao: {
    ...
    criteria1: string
    criteria2: string
    criteria3Before: string
    criteria3Link: string
    criteria3After: string
    criteria4: string
    linkTally: string
    linkContributeGov: string
    linkJoin: string
    linkDiscord: string
    linkWatch: string
  }
...
export const translations: Translations = {
  ...
  en: {
    ...
    aboutDao: {
      ...
      missionIntro: 'Our mission statement is:',
      missionStatement: 'We want to build integrations through mentoring and learning.',
      description:
      ...
      criteriaIntro: 'Any proposal submitted to the DAO should meet one of the following criteria:',
      criteria1: 'Organize local hackathons, workshops and meetups',
      criteria2: 'Request retroactive funding for a successful integration',
      criteria3Before: 'Develop and maintain ',
      criteria3Link: 'Gov',
      criteria3After: ': a DAO framework built with Governor and NFTs',
      criteria4: 'Help people to setup their own DAO',
      linkTally: 'View the DAO on Tally',
      linkContributeGov: 'Contribute to Gov',
      linkJoin: 'Join the WH3C',
      linkDiscord: 'Come say hi on Discord',
      linkWatch: 'Watch us building',
    },
  },
  ...
  zh: {
    ...
    aboutDao: {
      heading: '关于 W3HC',
      intro: 'Web3 黑客集体（W3HC）是一个于 2023 年 2 月 24 日创建的 DAO，部署在 Optimism 上。',
      missionIntro: '我们的使命宣言是：',
      missionStatement: '我们希望通过指导和学习来构建各种集成。',
      description:
        '我们的方法不是在一次次黑客马拉松中重新发明轮子，而是识别出有价值的 Web3 集成方向，并借此机会尽可能多地开展指导。',
      criteriaIntro: '提交给 DAO 的任何提案都应满足以下条件之一：',
      criteria1: '组织本地黑客马拉松、工作坊和聚会',
      criteria2: '为成功的集成申请追溯性资助',
      criteria3Before: '开发和维护 ',
      criteria3Link: 'Gov',
      criteria3After: '：一个基于 Governor 和 NFT 构建的 DAO 框架',
      criteria4: '帮助他人建立自己的 DAO',
      linkTally: '在 Tally 上查看该 DAO',
      linkContributeGov: '为 Gov 做贡献',
      linkJoin: '加入 WH3C',
      linkDiscord: '来 Discord 打个招呼',
      linkWatch: '观看我们的开发过程',
    },
  },
  ...
  hi: {
    ...
    aboutDao: {
      heading: 'W3HC के बारे में',
      intro:
        'Web3 Hackers Collective (W3HC) एक DAO है जिसे 24 फरवरी, 2023 को बनाया गया था। यह Optimism पर डिप्लॉय किया गया है।',
      missionIntro: 'हमारा मिशन स्टेटमेंट है:',
      missionStatement: 'हम मेंटरिंग और सीखने के ज़रिए इंटीग्रेशन बनाना चाहते हैं।',
      description:
        'हर हैकथॉन में पहिये का फिर से आविष्कार करने के बजाय, हमारा तरीका प्रासंगिक Web3 इंटीग्रेशन की पहचान करना और इन अवसरों का उपयोग अधिक से अधिक मेंटरिंग के लिए करना है।',
      criteriaIntro:
        'DAO को सबमिट किए गए किसी भी प्रस्ताव को निम्नलिखित में से किसी एक मानदंड को पूरा करना चाहिए:',
      criteria1: 'स्थानीय हैकथॉन, वर्कशॉप और मीटअप आयोजित करना',
      criteria2: 'किसी सफल इंटीग्रेशन के लिए रेट्रोएक्टिव फंडिंग का अनुरोध करना',
      criteria3Before: 'विकसित और बनाए रखना ',
      criteria3Link: 'Gov',
      criteria3After: ': Governor और NFTs से बना एक DAO फ्रेमवर्क',
      criteria4: 'लोगों को अपना खुद का DAO बनाने में मदद करना',
      linkTally: 'Tally पर DAO देखें',
      linkContributeGov: 'Gov में योगदान करें',
      linkJoin: 'WH3C से जुड़ें',
      linkDiscord: 'Discord पर आकर नमस्ते कहें',
      linkWatch: 'हमें बनाते हुए देखें',
    },
  },
  ...
  es: {
    ...
    aboutDao: {
      heading: 'Sobre W3HC',
      intro:
        'El Web3 Hackers Collective (W3HC) es una DAO creada el 24 de febrero de 2023. Está desplegada en Optimism.',
      missionIntro: 'Nuestra declaración de misión es:',
      missionStatement:
        'Queremos construir integraciones a través de la mentoría y el aprendizaje.',
      description:
        'En lugar de reinventar la rueda de hackathon en hackathon, nuestro enfoque consiste en identificar integraciones Web3 relevantes y aprovechar estas oportunidades para hacer tanta mentoría como sea posible.',
      criteriaIntro:
        'Cualquier propuesta enviada a la DAO debe cumplir uno de los siguientes criterios:',
      criteria1: 'Organizar hackathons, talleres y meetups locales',
      criteria2: 'Solicitar financiamiento retroactivo por una integración exitosa',
      criteria3Before: 'Desarrollar y mantener ',
      criteria3Link: 'Gov',
      criteria3After: ': un framework de DAO construido con Governor y NFTs',
      criteria4: 'Ayudar a las personas a crear su propia DAO',
      linkTally: 'Ver la DAO en Tally',
      linkContributeGov: 'Contribuir a Gov',
      linkJoin: 'Únete al WH3C',
      linkDiscord: 'Ven a saludarnos en Discord',
      linkWatch: 'Míranos construir',
    },
  },
  ...
  fr: {
    ...
    aboutDao: {
      heading: 'À propos de W3HC',
      intro:
        'Le Web3 Hackers Collective (W3HC) est une DAO créée le 24 février 2023. Elle est déployée sur Optimism.',
      missionIntro: 'Notre mission est la suivante :',
      missionStatement:
        "Nous voulons construire des intégrations par le mentorat et l'apprentissage.",
      description:
        'Plutôt que de réinventer la roue à chaque hackathon, notre approche consiste à identifier des intégrations Web3 pertinentes et à saisir ces occasions pour faire autant de mentorat que possible.',
      criteriaIntro:
        "Toute proposition soumise à la DAO doit répondre à l'un des critères suivants :",
      criteria1: 'Organiser des hackathons, ateliers et meetups locaux',
      criteria2: 'Demander un financement rétroactif pour une intégration réussie',
      criteria3Before: 'Développer et maintenir ',
      criteria3Link: 'Gov',
      criteria3After: ' : un framework de DAO construit avec Governor et des NFTs',
      criteria4: 'Aider les gens à mettre en place leur propre DAO',
      linkTally: 'Voir la DAO sur Tally',
      linkContributeGov: 'Contribuer à Gov',
      linkJoin: 'Rejoindre le WH3C',
      linkDiscord: 'Venez nous dire bonjour sur Discord',
      linkWatch: 'Regardez-nous construire',
    },
  },
  ...
  ar: {
    ...
    aboutDao: {
      heading: 'حول W3HC',
      intro:
        'Web3 Hackers Collective (W3HC) هي منظمة DAO تأسست في 24 فبراير 2023، وهي منشورة على شبكة Optimism.',
      missionIntro: 'بيان مهمتنا هو:',
      missionStatement: 'نريد بناء تكاملات من خلال الإرشاد والتعلّم.',
      description:
        'بدلاً من إعادة اختراع العجلة في كل هاكاثون، يقوم نهجنا على تحديد تكاملات Web3 ذات الصلة، واغتنام هذه الفرص لتقديم أكبر قدر ممكن من الإرشاد.',
      criteriaIntro: 'يجب أن يستوفي أي اقتراح يُقدَّم إلى DAO أحد المعايير التالية:',
      criteria1: 'تنظيم هاكاثونات وورش عمل ولقاءات محلية',
      criteria2: 'طلب تمويل بأثر رجعي مقابل تكامل ناجح',
      criteria3Before: 'تطوير وصيانة ',
      criteria3Link: 'Gov',
      criteria3After: ': إطار عمل DAO مبني باستخدام Governor و NFTs',
      criteria4: 'مساعدة الأشخاص على إنشاء DAO الخاصة بهم',
      linkTally: 'عرض DAO على Tally',
      linkContributeGov: 'المساهمة في Gov',
      linkJoin: 'انضم إلى WH3C',
      linkDiscord: 'تعال وألقِ التحية علينا على Discord',
      linkWatch: 'شاهدنا ونحن نبني',
    },
  },
  ...
  bn: {
    ...
    aboutDao: {
      heading: 'W3HC সম্পর্কে',
      intro:
        'Web3 Hackers Collective (W3HC) হলো একটি DAO যা ২০২৩ সালের ২৪ ফেব্রুয়ারি তৈরি হয়েছে। এটি Optimism-এ ডিপ্লয় করা হয়েছে।',
      missionIntro: 'আমাদের লক্ষ্য বিবৃতি হলো:',
      missionStatement: 'আমরা মেন্টরিং এবং শেখার মাধ্যমে ইন্টিগ্রেশন তৈরি করতে চাই।',
      description:
        'প্রতিটি হ্যাকাথনে নতুন করে চাকা আবিষ্কার না করে, আমাদের পদ্ধতি হলো প্রাসঙ্গিক Web3 ইন্টিগ্রেশন চিহ্নিত করা এবং যতটা সম্ভব মেন্টরিং করার জন্য এই সুযোগগুলো ব্যবহার করা।',
      criteriaIntro:
        'DAO-তে জমা দেওয়া যেকোনো প্রস্তাবকে নিম্নলিখিত মানদণ্ডগুলোর একটি পূরণ করতে হবে:',
      criteria1: 'স্থানীয় হ্যাকাথন, ওয়ার্কশপ এবং মিটআপ আয়োজন করা',
      criteria2: 'একটি সফল ইন্টিগ্রেশনের জন্য রেট্রোঅ্যাক্টিভ ফান্ডিং অনুরোধ করা',
      criteria3Before: 'তৈরি ও রক্ষণাবেক্ষণ করা ',
      criteria3Link: 'Gov',
      criteria3After: ': Governor এবং NFT দিয়ে তৈরি একটি DAO ফ্রেমওয়ার্ক',
      criteria4: 'মানুষকে তাদের নিজস্ব DAO তৈরি করতে সাহায্য করা',
      linkTally: 'Tally-তে DAO দেখুন',
      linkContributeGov: 'Gov-এ অবদান রাখুন',
      linkJoin: 'WH3C-তে যোগ দিন',
      linkDiscord: 'Discord-এ এসে হাই বলুন',
      linkWatch: 'আমাদের তৈরি করা দেখুন',
    },
  },
  ...
  ru: {
    ...
    aboutDao: {
      heading: 'О W3HC',
      intro:
        'Web3 Hackers Collective (W3HC) — это DAO, созданная 24 февраля 2023 года. Она развёрнута в сети Optimism.',
      missionIntro: 'Наша миссия:',
      missionStatement: 'Мы хотим создавать интеграции через менторство и обучение.',
      description:
        'Вместо того чтобы каждый раз изобретать велосипед от одного хакатона к другому, мы стремимся выявлять актуальные интеграции Web3 и использовать эти возможности для максимально активного менторства.',
      criteriaIntro:
        'Любое предложение, отправленное в DAO, должно соответствовать одному из следующих критериев:',
      criteria1: 'Организация локальных хакатонов, воркшопов и митапов',
      criteria2: 'Запрос ретроактивного финансирования за успешную интеграцию',
      criteria3Before: 'Разработка и поддержка ',
      criteria3Link: 'Gov',
      criteria3After: ' — фреймворка DAO, построенного на Governor и NFT',
      criteria4: 'Помощь людям в создании собственных DAO',
      linkTally: 'Посмотреть DAO на Tally',
      linkContributeGov: 'Внести вклад в Gov',
      linkJoin: 'Присоединиться к WH3C',
      linkDiscord: 'Заходите поздороваться в Discord',
      linkWatch: 'Смотрите, как мы работаем',
    },
  },
  ...
  pt: {
    ...
    aboutDao: {
      heading: 'Sobre a W3HC',
      intro:
        'A Web3 Hackers Collective (W3HC) é uma DAO criada em 24 de fevereiro de 2023. Está implantada na Optimism.',
      missionIntro: 'Nossa declaração de missão é:',
      missionStatement: 'Queremos construir integrações por meio de mentoria e aprendizado.',
      description:
        'Em vez de reinventar a roda a cada hackathon, nossa abordagem é identificar integrações Web3 relevantes e aproveitar essas oportunidades para fazer o máximo de mentoria possível.',
      criteriaIntro: 'Qualquer proposta enviada à DAO deve atender a um dos seguintes critérios:',
      criteria1: 'Organizar hackathons, workshops e meetups locais',
      criteria2: 'Solicitar financiamento retroativo por uma integração bem-sucedida',
      criteria3Before: 'Desenvolver e manter o ',
      criteria3Link: 'Gov',
      criteria3After: ': um framework de DAO construído com Governor e NFTs',
      criteria4: 'Ajudar pessoas a criar sua própria DAO',
      linkTally: 'Ver a DAO no Tally',
      linkContributeGov: 'Contribuir para o Gov',
      linkJoin: 'Junte-se à WH3C',
      linkDiscord: 'Venha nos dizer olá no Discord',
      linkWatch: 'Veja-nos construindo',
    },
  },
  ...
  ur: {
    ...
    aboutDao: {
      heading: 'W3HC کے بارے میں',
      intro:
        'Web3 Hackers Collective (W3HC) ایک DAO ہے جو 24 فروری 2023 کو بنایا گیا۔ یہ Optimism پر ڈیپلائے کیا گیا ہے۔',
      missionIntro: 'ہمارا مشن اسٹیٹمنٹ یہ ہے:',
      missionStatement: 'ہم مینٹرنگ اور سیکھنے کے ذریعے انٹیگریشنز بنانا چاہتے ہیں۔',
      description:
        'ہر ہیکاتھون میں پہیہ دوبارہ ایجاد کرنے کے بجائے، ہمارا طریقہ کار متعلقہ Web3 انٹیگریشنز کی نشاندہی کرنا اور ان مواقع کو زیادہ سے زیادہ مینٹرنگ کے لیے استعمال کرنا ہے۔',
      criteriaIntro:
        'DAO کو جمع کرائی گئی کسی بھی تجویز کو درج ذیل معیارات میں سے ایک پورا کرنا چاہیے:',
      criteria1: 'مقامی ہیکاتھونز، ورکشاپس اور میٹ اپس کا انعقاد',
      criteria2: 'کامیاب انٹیگریشن کے لیے ریٹرو ایکٹو فنڈنگ کی درخواست',
      criteria3Before: 'تیار اور برقرار رکھنا ',
      criteria3Link: 'Gov',
      criteria3After: ': ایک DAO فریم ورک جو Governor اور NFTs سے بنایا گیا ہے',
      criteria4: 'لوگوں کو اپنا DAO بنانے میں مدد کرنا',
      linkTally: 'Tally پر DAO دیکھیں',
      linkContributeGov: 'Gov میں حصہ ڈالیں',
      linkJoin: 'WH3C میں شامل ہوں',
      linkDiscord: 'Discord پر آ کر سلام کہیں',
      linkWatch: 'ہمیں بناتے ہوئے دیکھیں',
    },
  },
}
